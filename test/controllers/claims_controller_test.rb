...
class ClaimsControllerTest < ActionController::TestCase
  ...
  test "should create claim" do
    assert_difference('Claim.count') do
      post :create, claim: { contact_email: @claim.contact_email, contact_phone: @claim.contact_phone, memo: @claim.memo, name: @claim.name }
    end
  ...
  test "should update claim" do
    patch :update, id: @claim, claim: { contact_email: @claim.contact_email, contact_phone: @claim.contact_phone, memo: @claim.memo, name: @claim.name }
    assert_redirected_to claim_path(assigns(:claim))
  end
